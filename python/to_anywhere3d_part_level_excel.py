...
def main():
    ...
    collection = mydb['annotation_result_part_level']
    #print(documents)
    #print(mydb)
    ...
    for document in documents:
        #if document['cur_referring_expressions_cnt'] == '08' or document['cur_referring_expressions_cnt'] == '09':
    ...
    #df.to_excel('/home/wangtianxu/Viewer/anywhere3d_part_level_1_31.xlsx', header = True, index = True)
