...
def main():
    ...
    for document in documents:
        # if document['cur_referring_expressions_cnt'] == '05' or document['cur_referring_expressions_cnt'] == '06' or document['cur_referring_expressions_cnt'] == '07':
    ...
    print(anywhere3d_annotation_lis)
    ...
    # df.to_excel('/home/wangtianxu/anywhere3d_experiments/anywhere3d_datasets/anywhere3d_area_level_augmentation.xlsx', header = True, index = True)
