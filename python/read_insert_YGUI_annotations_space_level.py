...
#excel_file_path = '/home/wangtianxu/Viewer/anywhere3d_part_level_12_30.xlsx'

excel_file_path = '/home/wangtianxu/Viewer/anywhere3d_YGUI_annotation_2_5.xlsx'
...
for index, row in file.iterrows():
    ...
    if row['scene_id'] in all_validation_sets[row['datasetname']]:
        valid_annotation += 1
        data_insert = {
            "new_referring_expressions": row['new_referring_expressions_translation'],
