...
PROJECTION_ROOT = "/home/robot/datasets/scannet/ScanNet_projections/"
...
SCANNET_ROOT = "/home/robot/datasets/scannet/scans/"
AGGR_JSON = os.path.join(SCANNET_ROOT, "{}/{}.aggregation.json")
OUTPUT_ROOT = "/home/robot/datasets/scannet/ScanNet_galleries/"
...
if __name__ == "__main__":
    ...
    for i, scene_id in enumerate(scene_list):
        ...
        with open(AGGR_JSON.format(scene_id, scene_id)) as aggr_json:
            ...
            object_gallery = {}
            # count objects
            for j, pose_id in tqdm.tqdm(enumerate(pose_list)):
