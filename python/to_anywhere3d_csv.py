...
def main():
    ...
    for document in documents:
        ...
        if document['cur_referring_expressions_cnt'] != '08' and document['cur_referring_expressions_cnt'] != '09':
    ...
    #df.to_excel('/home/wangtianxu/Viewer/anywhere3d_space_level_annotation_99_expressions_by_ourselves.xlsx', header = True, index = True)
