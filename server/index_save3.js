...
scannet.scenegraphs = "static/ScanNetV2/scenegraphs/"
scannet.datasettype = "static/ScanNetV2/datasettype/"
...
router.get("/resource/scenegraph/:scene_id/:scenegraph", function(req, res) {
	let routed = path.join(__dirname, scannet.scenegraphs, req.params.scene_id, req.params.scenegraph);
	res.sendFile(routed);
});

router.get("/resource/datasettype/:datasettype", function(req, res) {
	let routed = path.join(__dirname, scannet.datasettype, req.params.datasettype);
	res.sendFile(routed);
});
	...
	MongoClient.connect(DB_URL, { useNewUrlParser: true }, function(err, client) {
		...
		async_tasks.push(function(callback) {
			...
			let query = {
				...
				referring_expressions: req.body.referring_expressions,
		...
		async.parallel(async_tasks, function(err, results){
			client.close();
			if (!err) {
				console.log(append_head("succeeded to save anywhere3D entry to collection "+sqa_collection+"annotator_id:"+req.body.annotator_id+" scene_id:"+req.body.scene_id+"; referring_expressions:"+req.body.referring_expressions+"; bounding_box_width:"+req.body.bounding_box_width+"; bounding_box_length:"+req.body.bounding_box_length+"; bounding_box_height:"+req.body.bounding_box_height+"; bounding_box_xpos:"+req.body.bounding_box_xpos + "; bounding_box_ypos:"+req.body.bounding_box_ypos+ "; bounding_box_zpos:"+req.body.bounding_box_zpos + "; bounding_box_rotation_angle:"+req.body.bounding_box_rotation_angle+"; hash1:"+req.body.hash1+"; hash2:"+req.body.hash2));
				res.sendStatus(200);
			}
			else {
				console.log(append_head("failed to save anywhere3D entry to collection "+sqa_collection+"annotator_id:"+req.body.annotator_id+" scene_id:"+req.body.scene_id+"; referring_expressions:"+req.body.referring_expressions+"; bounding_box_width:"+req.body.bounding_box_width+"; bounding_box_length:"+req.body.bounding_box_length+"; bounding_box_height:"+req.body.bounding_box_height+"; bounding_box_xpos:"+req.body.bounding_box_xpos + "; bounding_box_ypos:"+req.body.bounding_box_ypos+ "; bounding_box_zpos:"+req.body.bounding_box_zpos + "; bounding_box_rotation_angle:"+req.body.bounding_box_rotation_angle+"; hash1:"+req.body.hash1+"; hash2:"+req.body.hash2));
				res.sendStatus(503);
			}
		});
	});
