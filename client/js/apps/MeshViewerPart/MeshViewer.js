...
class MeshViewer {
		...
		Promise.all(promises).then(values => {
			...
			Promise.all(new_promises).then(new_values => {
				...
				*/
				...
				/////////////// *************************************************************************************************************************************** ////////////////
				/////////////// 								      For Predicted Bounding Box Visualizations                                             			////////////////
				/////////////// *************************************************************************************************************************************** ////////////////



				// const pred_bbx_edges = new THREE.EdgesGeometry(new THREE.BoxGeometry(0.5, 0.5, 0.5));
				// const pred_lineMaterial = new THREE.LineBasicMaterial({ color: 0x0000ff, opacity: 0.65, transparent: true, linewidth:4});
				...
				// this.add_listener(document.getElementById('pred_bounding_box_width'), 'input', this.updatePredCubeSize)
				// this.add_listener(document.getElementById('pred_bounding_box_length'), 'input', this.updatePredCubeSize)
				// this.add_listener(document.getElementById('pred_bounding_box_height'), 'input', this.updatePredCubeSize)
	...
	*/
	...
	updatePredCubeSize() {
		...
		this.bounding_box.position.copy(pred_bounding_box_current_position); 
	...
	setup_prompt_original() {
		...
		<div class="pred_bbx_container">
			<span class="label">pred_bbx_center_x:</span>
			<input type="number" id="pred_bounding_box_center_x_position" step="any">
			<label class="label">pred_bbx_center_y:</label>
			<input type="number" id="pred_bounding_box_center_y_position" step="any">
			<label class="label">pred_bbx_center_z:</label>
			<input type="number" id="pred_bounding_box_center_z_position" step="any">
			<label class="label">pred_bbx_length_x:</label>
			<input type="number" id="pred_bounding_box_x_length" step="any">
			<label class="label">pred_bbx_length_y:</label>
			<input type="number" id="pred_bounding_box_y_length" step="any">
			<label class="label">pred_bbx_length_z:</label>
			<input type="number" id="pred_bounding_box_z_length" step="any">
		</div>
		<h1><hr/></h1>
