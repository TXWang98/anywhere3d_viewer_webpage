	...
	*/
	...
	callAxes(){
		...
		if (this.axes_exist == 1){
			...
			this.axes_exist = 0
			document.getElementById('show_hide_axes').textContent = '显示坐标轴'
			...
			this.axes_exist = 1;
			document.getElementById('show_hide_axes').textContent = '隐藏坐标轴'
	...
	callCylinder(){
		...
		if(this.scale_cylinder_exist == 1){
			...
			document.getElementById('show_hide_cylinder').textContent = '显示度量尺'

		}else if(this.scale_cylinder_exist == 2){
			this.add_mesh(this.scene,[this.scale_cylinder])
			this.scale_cylinder_exist = 1
			document.getElementById('show_hide_cylinder').textContent = '隐藏度量尺'
		}
	}
	...
	*/
	...
	setup_control_bar(){
		...
		<div style="display: flex; justify-content: space-between;">
			<div style="width: 100%; padding: 20px; background-color: #f0f0f0; display: flex; flex-direction: column; justify-content: flex-start; overflow: auto">			
				...
				<button id="call_axes_button" style="width: 120px; height: 35px;" ><span id="show_hide_axes">显示坐标轴</span></button>
				<div style="display: flex; justify-content: space-between; width: 100%;">
					<p><span style="font-size: 1.2em;">三维标注框</span></p>
					<button id="reset_bounding_box_button" style="width: 120px; height: 35px;" >复原</button>
				</div>
				...
				<div style="display: flex; align-items: center; width: 100%;">
					<label for="bounding_box_rotation_angle" style="width: 30%;">旋转: <span id="bounding_box_rotation_value">0</span></label>
				...
				<div style="display: flex; justify-content: space-between; width: 100%;">
					<p><span style="font-size: 1.2em;">度量尺</span></p>
					<button id="reset_scale_cylinder_button" style="width: 120px; height: 35px; font-size: 14px;" >复原</button>
					<button id="call_cylinder_button" style="width: 120px; height: 35px; font-size: 14px;" ><span id="show_hide_cylinder">隐藏度量尺</span></button>
				</div>
				<div style="display: flex; align-items: center; width: 100%;">
				...
				<div style="display: flex; align-items: center; width: 100%;">
					<label for="scale_cylinder_rotation_angle" style="width: 30%;">旋转: <span id="scale_cylinder_rotation_value">0</span></label>
	...
	setup_prompt_original() {
		...
		<p style="margin-bottom: 10px;">
			<span style="font-size: 1.5em;"><b>指代短语ID:</span>
		...
		<div style="display: flex; width: 100%;">
			...
			<button id="btn_anywhere3D_submit" class="btn btn-primary btn-lg" type="submit" style="width: 100%">保存当前ID标注内容</button>
		</div>
		`;
