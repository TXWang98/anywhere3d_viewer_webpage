	...
	*/
	...
	setup_prompt_original() {
		...
		<div style="display: flex; width: 100%;">
			...
			<button id="btn_anywhere3D_submit" class="btn btn-primary btn-lg" type="submit" style="width: 100%">Save Current ID annotations</button>
		</div>
		`;
		...
		if (this.window_mesh.is_mouse_in_model_panel()) {
			...
			if (intersected.length > 0) {
				if (!(ignore_list.includes(intersected[0].object.material.emissive.getHex()))) {
					...
					//console.log(this.intersected_name)
