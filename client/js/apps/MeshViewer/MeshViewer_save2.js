		...
		Promise.all(promises).then(values => {
			...
			Promise.all(new_promises).then(new_values => {
				...
				*/
				...
				this.add_listener(document.getElementById('remove_scale_cylinder'),"click",this.remove_scale_cylinder)
		...
		<div id="controls">
			<div style="display: flex; justify-content: space-between; height: 40vh;">
				...
				<div style="width: 70%; padding: 20px; background-color: #f0f0f0; display: flex; flex-direction: column; justify-content: flex-start;">			
					...
					<label for="bounding_box_width" style="color: #ff0000;">Bounding Box Width</label>
					<input type="range" id="bounding_box_width" min="0" max="3" step="0.05" value="0.5" style="width: 100%; margin-top: 10px;">
					<label for="bounding_box_depth" style="color: #00ff00;">Bounding Box Depth</label>
					<input type="range" id="bounding_box_depth" min="0" max="3" step="0.05" value="0.5" style="width: 100%; margin-top: 10px;">
					<label for="bounding_box_height" style="color: #0000ff;">Bounding Box Height</label>
			...
			<button id="remove_scale_cylinder">Remove Scale Cylinder</button><br>
    	</div>
		<div>
