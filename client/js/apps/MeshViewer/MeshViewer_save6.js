...
class MeshViewer {
	...
	*/
		...
		<div style="display: flex; justify-content: space-between;">
			<div style="width: 100%; padding: 20px; background-color: #f0f0f0; display: flex; flex-direction: column; justify-content: flex-start; overflow: auto">			
				<div style="display: flex; justify-content: space-between; width: 100%;">
					<button id="call_axes_button" >Axes</button>
					<button id="call_cylinder_button" >Cylinder</button>
				</div>
				...
				<div style="display: flex; align-items: center; width: 100%;">
					<label for="bounding_box_width" style="color: #ff0000; width: 30%;">Width: <span id="bounding_box_width_value">0.5</span></label>
					<input type="range" id="bounding_box_width" min="0" max="4" step="0.01" value="0.5" style="flex-grow: 1;">
				</div>
				<div style="display: flex; align-items: center; width: 100%;">
					<label for="bounding_box_length" style="color: #228B22; width: 30%;">Length: <span id="bounding_box_length_value">0.5</span></label>
					<input type="range" id="bounding_box_length" min="0" max="4" step="0.01" value="0.5" style="flex-grow: 1;">
				</div>
				<div style="display: flex; align-items: center; width: 100%;">
					<label for="bounding_box_height" style="color: #0000ff; width: 30%;">Height: <span id="bounding_box_height_value">0.5</span></label>
					<input type="range" id="bounding_box_height" min="0" max="3" step="0.01" value="0.5" style="flex-grow: 1;">
				</div>
				<div style="display: flex; align-items: center; width: 100%;">
					<label for="bounding_box_rotation_angle" style="width: 30%;">Rotation: <span id="bounding_box_rotation_value">0</span></label>
					<input type="range" id="bounding_box_rotation_angle" min="0" max="360" step = "1" value="0" style="flex-grow: 1;"><br>
				</div>
				<div style="display: flex; align-items: center; width: 100%;">
					<label for="bounding_box_center_x_position" style="color: #ff0000; width: 30%;">X Position</label>
					<input type="range" id="bounding_box_center_x_position" min="-5" max="5" step="0.01" value="0" style="flex-grow: 1;">
				</div>
				<div style="display: flex; align-items: center; width: 100%;">
					<label for="bounding_box_center_y_position" style="color: #228B22; width: 30%;">Y Position</label>
					<input type="range" id="bounding_box_center_y_position" min="-5" max="5" step="0.01" value="0" style="flex-grow: 1;">
				</div>
				<div style="display: flex; align-items: center; width: 100%;">
					<label for="bounding_box_center_z_position" style="color: #0000ff; width: 30%;">Z Position</label>
				...
				<div style="display: flex; align-items: center; width: 100%;">
					<label for="scale_cylinder_diameter" style="width: 30%;">Length: <span id="scale_cylinder_bar_height">0.5</span></label>
					<input type="range" id="modify_scale_cylinder" min="0" max="10" step = "0.01" value="0.5" style="flex-grow: 1;">		
				</div>
				<div style="display: flex; align-items: center; width: 100%;">
					<label for="scale_cylinder_rotation_angle" style="width: 30%;">Rotation: <span id="scale_cylinder_rotation_value">0</span></label>
	...
	setup_prompt_original() {
		...
		<h1><hr/></h1>
		<p style="margin-bottom: 10px;"><span style="font-size: 1.5em;"><b>Referring Expressions:</b> Facing the bicycle, place a trash bin 0.5m in diameter and 0.75m in height on the floor. It should be located 1m away directly to the right of the bed.</span></p>
		<!--
