	...
	*/
	...
	setup_control_bar(){
		...
		<div id="controls">
			...
			<button id="hide_scale_cylinder">Hide Scale Cylinder</button>
			<br>
			<br>
			<div style="display: flex; justify-content: space-between; height: 45vh;">
				<!-- 左侧内容 -->
				<div style="width: 50%; padding: 20px; background-color: #f0f0f0; display: flex; flex-direction: column; justify-content: flex-start;">			
				...
				<!-- 右侧内容 -->
				<div style="width: 50%; padding: 20px; background-color: #e0e0e0; display: flex; flex-direction: column; justify-content: flex-start;">
					<!--div class="tickmarks" style="position: relative; width: 100%; display: flex; justify-content: space-between; margin-bottom: 10px;">
						<span>-</span>
						<span>+</span>
					</div-->
	...
	setup_prompt_original() {
		...
		<h1><hr/></h1>
		<p style="margin-bottom: 10px;"><span style="font-size: 1.5em;">Facing the bicycle, place a trash bin 0.5m in diameter and 0.75m in height on the floor. It should be located 1m away directly to the right of the bed.</span></p>
		<!--
		...
		<!--div id="control_bar_container" style={{"position": "absolute", "height": "65%", "left": "0%", "width": "34%", "float": "left", "display": "none"}}>
