...
class MeshViewer {
	...
	*/
	...
	setup_prompt_original() {
		...
		-->
		<div id="controls">
			<div style="display: flex; justify-content: space-between; height: 40vh;">
				<!-- 左侧内容 -->
				<div style="width: 70%; padding: 20px; background-color: #f0f0f0; display: flex; flex-direction: column; justify-content: flex-start;">			
					...
					<input type="range" id="bounding_box_width" min="0" max="10" step="0.05" value="0.5" style="width: 100%; margin-top: 10px;">
					<label for="bounding_box_depth" style="color: #00ff00;">Bounding Box Depth: <span id="bounding_box_depth_value">0.5</span></label>
					<input type="range" id="bounding_box_depth" min="0" max="10" step="0.05" value="0.5" style="width: 100%; margin-top: 10px;">
					<label for="bounding_box_height" style="color: #0000ff;">Bounding Box Height: <span id="bounding_box_height_value">0.5</span></label>
					<input type="range" id="bounding_box_height" min="0" max="10" step="0.05" value="0.5" style="width: 100%; margin-top: 10px;">
