...
class MeshViewer {
		...
		Promise.all(promises).then(values => {
			...
			Promise.all(new_promises).then(new_values => {
				...
				*/
				...
				this.add_listener(document.getElementById('reset_bounding_box'), "click", this.reset_bounding_box)
	...
	*/
	...
	modify_scale_cylinder() {
		...
		const new_cylinder_height = parseFloat(document.getElementById('modify_scale_cylinder').value) || 0.01;
		...
		<div style="display: flex; justify-content: space-between;">
			<div style="width: 100%; padding: 20px; background-color: #f0f0f0; display: flex; flex-direction: column; justify-content: flex-start; overflow: auto">			
				...
				<div style="display: flex; justify-content: space-between; width: 100%;">
					...
					<button id="reset_bounding_box" style="width: 120px; height: 35px;" >Reset</button>
				</div>
				...
				<div style="display: flex; justify-content: space-between; width: 100%;">
					...
					<button id="call_cylinder_button" style="width: 120px; height: 35px;" ><span id="show_hide_cylinder">Hide Cylinder</span></button>
				</div>
				<div style="display: flex; align-items: center; width: 100%;">
